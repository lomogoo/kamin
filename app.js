...
// app.js の appData.subscription_plans の部分を以下のように書き換えてください
  ...
  "subscription_plans": [
    ...
    {
      "name": "プレミアムプラン", 
      "price_monthly": 4980, // 価格を4980円に変更
      "price_yearly": 49800, // 年額プランも更新 (例: 2ヶ月分お得)
      "features": [
          "詳細な睡眠分析", 
          "無制限のデータ保存", 
          "優先ポッド予約", 
          "専門家記事", 
          "パーソナライズ機能",
          "毎日1杯のデカフェコーヒー付（kamin de cafe）" // 特典を追加
      ]
    },
    // --- ▲ プレミアムプランの修正 ▲ ---

    // --- ▼ ファミリープランからスタンダードプランへの修正 ▼ ---
    {
      "name": "スタンダードプラン", // 名称を「スタンダードプラン」に変更
      "price_monthly": 2980, // 価格を2980円に変更
      "price_yearly": 29800, // 年額プランも更新 (例: 2ヶ月分お得)
      "features": [ // 特典を新しい内容に完全に入れ替え
        "仮眠を毎日の生活習慣に取り入れましょう。",
        "1日2時間までの利用。（1回30分~90分）",
        "月に4回以上利用する方は、サブスクがお得。",
        "ポッドの事前予約が可能（キャンセル料有）"
      ]
    }
    // --- ▲ スタンダードプランの修正 ▲ ---
